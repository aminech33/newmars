...
import { useStore, Task, Project } from '../../store/useStore'
...
export function AssignTasksToProjectModal({ isOpen, onClose, project }: AssignTasksToProjectModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/50 backdrop-blur-sm animate-fade-in">
      <div className="w-full max-w-4xl bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl max-h-[90vh] flex flex-col">
        {/* Header */}
            ...
            <div className="p-4 border-b border-zinc-800 space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-800 text-zinc-200 placeholder:text-zinc-600 pl-10 pr-4 py-2 rounded-lg border border-zinc-700 focus:outline-none focus:border-indigo-500 transition-colors text-sm"
                />
              </div>
              ...
              <label className="flex items-center gap-2 text-sm text-zinc-400 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-zinc-700 bg-zinc-800 text-indigo-500 focus:ring-indigo-500 focus:ring-offset-0"
                />
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-2">
              {currentProjectTasks.length === 0 ? (
                ...
                currentProjectTasks.map(task => (
                  <div
                    key={task.id}
                    className="p-3 rounded-lg bg-zinc-800/50 border border-zinc-700 group"
                  >
        ...
        <div className="flex items-center justify-between p-4 border-t border-zinc-800">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-2 text-sm bg-indigo-500/20 text-indigo-400 rounded-lg hover:bg-indigo-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
            >
