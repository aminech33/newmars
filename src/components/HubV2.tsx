...
export function HubV2() {
  ...
  return (
    <div className="min-h-full w-full overflow-y-auto">
      <div 
        className={`w-full max-w-[1800px] mx-auto px-6 lg:px-8 py-6 transition-colors duration-700 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
      >
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 text-xs text-zinc-600 hover:text-zinc-400 shadow-[0_2px_8px_rgba(0,0,0,0.2)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.3)] rounded-xl transition-colors duration-300"
            ...
            {isEditMode && (
              <>
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-1.5 text-xs text-zinc-400 hover:text-zinc-200 shadow-[0_2px_8px_rgba(0,0,0,0.2)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.3)] rounded-xl transition-colors duration-300"
                  style={{ border: '1px solid rgba(255,255,255,0.08)' }}
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 text-xs rounded-xl transition-colors duration-300 ${
                isEditMode
