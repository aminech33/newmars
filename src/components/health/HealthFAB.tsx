      ...
      {isExpanded && (
        <div className="flex flex-col gap-2 animate-fade-in">
          <button
            ...
            className="flex items-center gap-2 px-4 py-3 bg-rose-500 text-white rounded-full shadow-lg hover:bg-rose-600 transition-all"
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-3 bg-emerald-500 text-white rounded-full shadow-lg hover:bg-emerald-600 transition-all"
