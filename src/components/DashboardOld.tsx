...
// Composant StatCard - Version analytique pure (non cliquable)
function StatCard({ 
  icon, 
  label, 
  value, 
  ...
  // Couleurs neutralisées - toutes utilisent zinc
  const colorClasses = 'from-zinc-800/30 to-transparent border-zinc-800/50'
  ...
  const iconColors = {
    ...
    orange: 'text-zinc-500',
    zinc: 'text-zinc-500'
  }

  return (
    <div
      className={`text-left p-4 rounded-xl bg-gradient-to-br ${colorClasses} border w-full`}
      aria-label={`${label}: ${value}${subValue ? `, ${subValue}` : ''}`}
    >
      <div className="flex items-start justify-between mb-3">
        <div className={`p-2 rounded-lg bg-zinc-900/50 ${iconColors[color]}`}>
          {icon}
        </div>
        {trend && (
...
// Composant Section - Version analytique pure (sans navigation)
  ...
  return (
    <section className="mb-8" aria-labelledby={title.replace(/\s/g, '-').toLowerCase()}>
      <div className="flex items-center gap-3 mb-4">
        ...
        <h3 id={title.replace(/\s/g, '-').toLowerCase()} className="text-base font-medium text-zinc-400">{title}</h3>
      </div>
      {children}
    </section>
  )
      ...
      <header className="flex-shrink-0 px-4 py-2 border-b border-zinc-800/50">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-medium text-zinc-400">Dashboard • Rapport analytique</h1>
            
            {/* Score Global - Neutre et informatif */}
            <Tooltip content={scoreTooltipContent} side="bottom">
              <div className="flex items-center gap-1.5 px-2 py-1 bg-zinc-900/50 rounded-lg cursor-help ml-2">
      ...
      <div className="flex-1 overflow-auto px-4 py-3">
          ...
          {activeTab === 'overview' && (
            <div 
              ...
              className="space-y-4"
            >
              {/* Vue d'ensemble - Indicateurs rétrospectifs */}
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3">
                ...
                <StatCard
                  ...
                  subValue={stats.journal.hasTodayEntry ? 'Entrée enregistrée' : 'Aucune entrée'}
                  color="violet"
                />
                <StatCard
              ...
              {/* Séries de consistance */}
              <Section title="Séries de consistance" icon={<Flame className="w-5 h-5 text-zinc-500" />}>
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                  {[
                    ...
                    <div key={streak.label} className="glass-widget p-4 text-center border-zinc-800/50">
                      ...
                      <p className="text-[10px] text-zinc-700 mt-1">{streak.value} jours consécutifs</p>
                    </div>
                  ))}
                </div>
              </Section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Section 
                  title="Tâches complétées (7 jours)" 
                  icon={<BarChart3 className="w-5 h-5 text-zinc-500" />}
                >
                  <div className="glass-widget p-6 border-zinc-800/50">
                    <BarChart
                ...
                <Section 
                  title="Temps de focus (7 jours)" 
                  icon={<Timer className="w-5 h-5 text-zinc-500" />}
                >
                  <div className="glass-widget p-6 border-zinc-800/50">
                    <BarChart
              ...
              {(stats.correlations.moodVsHabitsRate !== null || stats.correlations.productivityVsPomodoro !== null) && (
                <Section title="Corrélations observées" icon={<Activity className="w-5 h-5 text-zinc-500" />}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {stats.correlations.moodVsHabitsRate !== null && (
                      <div className="glass-widget p-4 border-zinc-800/50">
          ...
          {activeTab === 'habits' && (
            ...
            >
              <Section 
                ...
                icon={<Flame className="w-5 h-5 text-zinc-500" />}
              >
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          ...
          {activeTab === 'health' && (
            ...
            >
              <Section 
                ...
                icon={<Heart className="w-5 h-5 text-zinc-500" />}
              >
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                  <StatCard 
          ...
          {activeTab === 'library' && (
            ...
            >
              <Section 
                ...
                icon={<BookMarked className="w-5 h-5 text-zinc-500" />}
              >
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          ...
          {activeTab === 'learning' && (
            ...
            >
              <Section 
                ...
                icon={<GraduationCap className="w-5 h-5 text-zinc-500" />}
              >
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          ...
          {activeTab === 'correlations' && (
            <div 
              ...
              className="space-y-8"
            >
              <Section title="Corrélations statistiques" icon={<Activity className="w-5 h-5 text-zinc-500" />}>
                <div className="glass-widget p-6 mb-6 border-zinc-800/50">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="glass-widget p-6 border-zinc-800/50">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="flex items-center gap-2">
                        <Smile className="w-5 h-5 text-zinc-500" aria-hidden="true" />
                        <span className="text-sm text-zinc-500">Humeur</span>
                      </div>
                      <Activity className="w-4 h-4 text-zinc-600" aria-hidden="true" />
                      <div className="flex items-center gap-2">
                        <Flame className="w-5 h-5 text-zinc-500" aria-hidden="true" />
                  ...
                  <div className="glass-widget p-6 border-zinc-800/50">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <Activity className="w-4 h-4 text-zinc-600" aria-hidden="true" />
                      <div className="flex items-center gap-2">
                        <Timer className="w-5 h-5 text-zinc-500" aria-hidden="true" />
